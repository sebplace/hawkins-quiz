/* ==================================================================
   ...
   Indexée sur l'id stable de la question, pas sur son intitulé
   français : corriger une coquille en français ne casse plus rien.
   Une question sans entrée ici n'est simplement pas proposée en
   anglais. Pour les choix multiples, l'ordre DOIT suivre celui du
   français, la bonne réponse restant en première position.
================================================================== */
...
const QUESTIONS_EN = {
  ...
  "joyce-byers-travaille": {
    ...
    choices: [
      "At Melvald's General Store",
      "At RadioShack",
      "At the Palace Arcade",
      "At Benny's"
    ],
  ...
  "porte-coup-fatal": {
    ...
    choices: [
      "Joyce Byers, with an axe",
      "Eleven, by telekinesis",
      "Hopper, with a rifle",
      "Will, by turning his powers back on him"
    ],
  ...
  "revele-saison-nature": {
    ...
    choices: [
      "It is not a dimension but a wormhole",
      "It is a collective dream of Vecna's",
      "It is Hawkins' future",
      "It is a laboratory simulation"
    ],
  ...
  "vient-reellement-pouvoir": {
    ...
    choices: [
      "A scarlet stone he found in a mine as a child",
      "An experiment by Doctor Brenner",
      "A Demogorgon bite",
      "He was born with it"
    ],
  ...
  "remettez-trois-moments": {
    ...
    steps: [
      "Holly disappears from Hawkins",
      "Max wakes from her coma",
      "Joyce beheads Vecna"
    ],
  ...
  "suzie": {
    q: "Who is Suzie?",
    choices: [
      "Dustin's girlfriend, in Utah",
      "Robin's sister",
      "A Russian scientist",
      "The English teacher at Hawkins High"
    ],
  ...
  "salle-arcade-madmax": {
    ...
    choices: [
      "The Palace Arcade",
      "The Starcourt Arcade",
      "The Hawkins Fun Center",
      "Surfer Boy"
    ],
  ...
  "pourrit-champs-citrouilles": {
    ...
    choices: [
      "The whole crop, poisoned from the tunnels",
      "Nothing, it's a rumour",
      "Only the Byers' field",
      "The potatoes, not the pumpkins"
    ],
  ...
  "robin-perce-code": {
    ...
    choices: [
      "She speaks four languages and decodes it by ear",
      "She has an uncle who is a translator",
      "She uses the lab's computer",
      "She asks Murray"
    ],
  ...
  "gamins-tentent-neutraliser": {
    ...
    choices: [
      "By locking him in the sauna",
      "By knocking him out with a bat",
      "By luring him to the lab",
  ...
  "victor-creel-trouve": {
    ...
    choices: [
      "Henry's father, committed to Pennhurst Asylum",
      "A scientist at the Hawkins lab",
      "The mayor of Hawkins",
      "A former colleague of Brenner's"
    ],
  ...
  "remettez-trois-moments-2": {
    ...
    steps: [
      "Billy hits the creature at the steelworks",
      "Heather is taken at the pool",
      "Starcourt Mall goes up in flames"
    ],
  ...
  "date-monde-envers": {
    ...
    choices: [
      "6 November 1983, the day Will vanished",
      "4 July 1985, the day of Starcourt",
      "1 January 1986",
      "No date at all: it has no time"
    ],
  ...
  "metier-exerce-heather": {
    ...
    choices: [
      "Lifeguard at the public pool",
      "Shop assistant at Starcourt Mall",
      "Waitress at Enzo's",
      "Reporter at the Hawkins Post"
    ],
  ...
  "gamins-detournent-demodogs": {
    ...
    choices: [
      "By torching the tunnel hub with petrol",
      "By baiting them with raw meat",
      "By broadcasting a radio signal",
      "By spreading salt in the tunnels"
    ],
  ...
  "nancy-jonathan-preparent": {
    ...
    choices: [
      "A bear trap, petrol and a great deal of recklessness",
      "An electrified cage",
      "A net and a spiked bat",
      "A homemade bomb"
    ],
  ...
  "connie-frazier": {
    ...
    choices: [
      "The undercover lab agent who shoots Benny",
      "A lab nurse",
      "Barb's mother",
      "A Hawkins journalist"
    ],
  ...
  "eleven-montre-pouvoirs": {
    ...
    choices: [
      "She slams the bedroom door from across the room",
      "She crushes a can with her mind",
      "She levitates the Millennium Falcon",
      "She lights up the Christmas lights"
    ],
  ...
  "remettez-trois-moments-3": {
    ...
    steps: [
      "Will disappears on the way home",
      "Joyce paints the alphabet on the living room wall",
      "The boys fill a paddling pool with salt"
    ],
  ...
  "nom-creature-dustin": {
    q: "What does Dustin name the creature he takes in during season 2?",
    choices: [
      "Dart",
      "Rex",
      "Yertle",
    ...
    fact: "Dart, short for D'Artagnan. Yertle was the turtle. Dustin has a theme."
  },
  "travail-steve-robin-1985": {
    q: "Where do Steve and Robin work during the summer of 1985?",
    choices: [
      "At Scoops Ahoy, the Starcourt ice cream parlour",
      "At the Palace Arcade",
      "At Melvald's General Store",
      "At the Hawkins Post"
    ],
    fact: "Scoops Ahoy. The sailor hat wasn't negotiable, and neither was the contract."
  },
  "epeler-centre-commercial": {
    q: "Spell the name of the Hawkins shopping mall.",
    fact: "Starcourt. It killed downtown Hawkins long before the Russians moved into the basement."
  },
  "club-donjons-dragons-lycee": {
    q: "What is the Hawkins High Dungeons & Dragons club called?",
    choices: [
      "The Hellfire Club",
      "The Dragon Club",
      "The AV Club",
    ...
    fact: "The Hellfire Club, chaired by Eddie Munson. T-shirts included."
  },
  "morceau-sauve-max": {
    q: "Which track pulls Max out of Vecna's grip?",
    choices: [
      "Running Up That Hill",
    ...
    fact: "Running Up That Hill, by Kate Bush. Released in 1985, back at the top of the charts thirty-seven years later."
  },
  "ou-vit-eleven-debut": {
    q: "Where does Eleven live at the start of season 4?",
    choices: [
      "In Lenora Hills, California",
      "In Hawkins",
      "In Chicago",
    ...
    fact: "Lenora Hills, California. The sunshine didn't help, and high school helped even less."
  },
  "instrument-eddie-munson": {
    q: "Which instrument does Eddie Munson play?",
    choices: [
      "Electric guitar",
      "Drums",
      "Keyboards",
    ...
    fact: "Guitar. The bravest solo ever played from the roof of a trailer."
  },
  "combien-receptacles-vecna": {
    q: "How many children does Vecna abduct to serve as his \u201cperfect vessels\u201d?",
    choices: [
      "Twelve",
      "Four",
      "Seven",
    ...
    fact: "Twelve. Vecna never did do things by halves, or quietly."
  },
  "envers-dimension-parallele": {
    q: "The Upside Down really is a parallel dimension, just as everyone assumed back in 1983.",
    fact: "False: season 5 finally settles it, it's a wormhole. Four seasons of misunderstanding."
  },
  "ministere-laboratoire-hawkins": {
    q: "Which US department does the Hawkins laboratory officially answer to?",
    choices: [
    ...
    fact: "The Department of Energy. A convenient cover for a corridor that leads nowhere near a power plant."
  },
  "pseudo-arcade-max": {
    q: "Under which handle does Max sit at the top of the arcade leaderboard?",
    choices: [
      "MADMAX",
      "MAXINE",
      "ZOOMER",
    ...
    fact: "MADMAX, on Dig Dug. Dustin and Lucas investigated for weeks only to end up behind a thirteen-year-old girl."
  }
};
