/* ------------------------------------------------------------------
   ...
   `id`    : identifiant stable, clé des traductions. Ne change JAMAIS,
             même si l'intitulé français est corrigé.
...
const QUESTIONS = [
  ...
  {
    id: "garcons-deguisent-halloween",
    level: 1, s: 2,
  ...
  ================================================================ */
  {
    id: "laboratoire-gentiment-perce",
    level: 2, s: 1,
  ...
  {
    id: "programme-gouvernemental-servi",
    level: 2, s: 1,
  ...
  {
    id: "garcons-improvisent-caisson",
    level: 2, s: 1,
  ...
  {
    id: "professeur-sciences-fournit",
    level: 3, s: 1,
  ...
  {
    id: "installation-eleven-retrouve",
    level: 3, s: 4,
  ...
  {
    id: "contrebandier-russe-accepte",
    level: 3, s: 4,
  ...
  /* ================================================================
     COMPLÉMENT — équilibrage des couples niveau × saison
  ================================================================ */
  {
    level: 1, s: 2,
    id: "nom-creature-dustin",
    q: "Quel nom Dustin donne-t-il à la créature qu'il recueille en saison 2 ?",
    choices: ["Dart", "Rex", "Yertle", "Spock"],
    fact: "Dart, diminutif de D'Artagnan. Yertle, c'était la tortue. Dustin a un thème."
  },
  {
    level: 1, s: 3,
    id: "travail-steve-robin-1985",
    q: "Où Steve et Robin travaillent-ils pendant l'été 1985 ?",
    choices: [
      "Chez Scoops Ahoy, le glacier du Starcourt",
      "Au Palace Arcade",
      "Chez Melvald's General Store",
      "Au Hawkins Post"
    ],
    fact: "Scoops Ahoy. Le chapeau de marin n'était pas négociable, le contrat non plus."
  },
  {
    level: 1, s: 3, type: "spell",
    id: "epeler-centre-commercial",
    q: "Épelez le nom du centre commercial de Hawkins.",
    answer: "STARCOURT",
    fact: "Le Starcourt. Il a tué le centre-ville bien avant que les Russes ne s'installent au sous-sol."
  },
  {
    level: 1, s: 4,
    id: "club-donjons-dragons-lycee",
    q: "Comment s'appelle le club de Donjons & Dragons du lycée de Hawkins ?",
    choices: ["Le Hellfire Club", "Le Dragon Club", "Le Club AV", "Le Cerebro Club"],
    fact: "Le Hellfire Club, présidé par Eddie Munson. Les t-shirts étaient fournis."
  },
  {
    level: 1, s: 4,
    id: "morceau-sauve-max",
    q: "Quel morceau arrache Max à Vecna ?",
    choices: [
    ...
    fact: "Running Up That Hill, de Kate Bush. Sorti en 1985, remis en tête des ventes trente-sept ans plus tard."
  },
  {
    level: 1, s: 4,
    id: "ou-vit-eleven-debut",
    q: "Où Eleven vit-elle au début de la saison 4 ?",
    choices: ["À Lenora Hills, en Californie", "À Hawkins", "À Chicago", "En Alaska"],
    fact: "Lenora Hills, Californie. Le soleil n'a rien arrangé, et le lycée encore moins."
  },
  {
    level: 1, s: 4,
    id: "instrument-eddie-munson",
    q: "De quel instrument Eddie Munson joue-t-il ?",
    choices: ["De la guitare électrique", "De la batterie", "Du clavier", "De la basse"],
    fact: "La guitare. Le solo le plus courageux jamais joué depuis le toit d'une caravane."
  },
  {
    level: 2, s: 5,
    id: "combien-receptacles-vecna",
    q: "Combien d'enfants Vecna enlève-t-il pour en faire ses « réceptacles parfaits » ?",
    choices: ["Douze", "Quatre", "Sept", "Vingt et un"],
    fact: "Douze. Vecna n'a jamais eu le sens de la demi-mesure, ni celui du dénombrement discret."
  },
  {
    level: 2, s: 5, type: "vf",
    id: "envers-dimension-parallele",
    q: "Le Monde à l'Envers est bien une dimension parallèle, comme on le croyait depuis 1983.",
    answer: false,
    fact: "Faux : la saison 5 tranche enfin, c'est un trou de ver. Quatre saisons de malentendu."
  },
  {
    level: 3, s: 1,
    id: "ministere-laboratoire-hawkins",
    q: "De quel ministère américain le laboratoire de Hawkins dépend-il officiellement ?",
    choices: [
    ...
    fact: "Le département de l'Énergie. Une couverture commode pour un couloir qui ne mène pas à une centrale."
  },
  {
    level: 3, s: 2,
    id: "pseudo-arcade-max",
    q: "Sous quel pseudonyme Max trône-t-elle en haut du tableau des scores de l'arcade ?",
    choices: ["MADMAX", "MAXINE", "ZOOMER", "REDHEAD"],
    fact: "MADMAX, sur Dig Dug. Dustin et Lucas ont enquêté des semaines pour finir devant une fille de treize ans."
  }
];
